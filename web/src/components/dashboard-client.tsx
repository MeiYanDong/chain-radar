...
export function DashboardClient({ initialHolders, initialTransactions, initialSummary, walletNames }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">FAT Token Dashboard</h1>
